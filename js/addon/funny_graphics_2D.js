...
( function () {
										...
										window.btb$.graph			= window.btb$.graph			|| {};
		var draw2D					=	window.btb$.graph.draw2D	= window.btb$.graph.draw2D	|| {};
		var	addon					=	window.btb$.graph.addon		= window.btb$.graph.addon	|| {};
		var	funny_graphics_2D		=	addon.funny_graphics_2D		= addon.funny_graphics_2D	|| {};
		...
		funny_graphics_2D.createRandomDisks=function(grainsNumber,width,height){
